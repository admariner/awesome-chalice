...
## AWS Projects
- [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) - Described as "Pandas on AWS": *Easy integration with Athena, Glue, Redshift, Timestream, QuickSight, Chime, CloudWatchLogs, DynamoDB, EMR, SecretManager, PostgreSQL, MySQL, SQLServer and S3 (Parquet, CSV, JSON and EXCEL).* This project by AWS ProServ integrates Pandas with all sorts of AWS backend stores.
