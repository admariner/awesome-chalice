...
* `current` [AWS Cloud Development Kit (CDK)](https://aws.amazon.com/cdk/) `aws.amazon.com` ![#90EE90](https://via.placeholder.com/15/90EE90/000000?text=+)
  * You can code up your infrastructure using the CDK in the same project that you write your Chalice application code in, using Chalice's ability to [be deployed by the AWS CDK](https://aws.amazon.com/blogs/developer/deploying-aws-chalice-application-using-aws-cloud-development-kit/). You can find CDK Constructs in the [AWS CDK Construct Library](https://docs.aws.amazon.com/cdk/api/latest/docs/aws-construct-library.html), which contains constructs for many AWS services. You can use Chalice to deploy itself via the CDK, allowing you to separate infrastructure from application and operations. Use Chalice to write your apps and run your Ops. Use the CDK to deploy infrastructure. Use Chalice to run the CDK.
